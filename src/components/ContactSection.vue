      ...
      <div class="mt-12 text-center opacity-0 translate-y-8 animate-fade-in-up" style="animation-delay: 1200ms;">
        ...
        <div class="flex justify-center space-x-6">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="group w-12 h-12 bg-white rounded-full shadow-lg flex items-center justify-center text-gray-600 hover:text-white hover:bg-black transition-all duration-300 transform hover:scale-110 hover:-translate-y-2"
          >
            <svg class="w-6 h-6 transition-all duration-300 group-hover:scale-110" fill="currentColor" viewBox="0 0 24 24">
